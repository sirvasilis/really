...
const Index = () => {
  ...
  const translations = {
    el: {
      ...
      timeMachinePlaceholder: "Γράψε την ιδέα σου εδώ και ταξίδεψε στο μέλλον για να δεις το αποτέλεσμα",
    ...
    en: {
      ...
      timeMachinePlaceholder: "Write your idea here and travel to the future to see the outcome",
